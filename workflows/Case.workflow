...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>MFG_IoT_Error_Reported</fullName>
        <description>IoT Error Reported</description>
        ...
        <template>IOT/MFG_IoT_Error_Reported</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Send_customer_satisfaction_survey</fullName>
        <description>Send customer satisfaction survey</description>
        <protected>false</protected>
        <recipients>
            <field>ContactId</field>
            <type>contactLookup</type>
        ...
        <senderType>CurrentUser</senderType>
        <template>ServiceTemplates/Default_Email_Template</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        <fullName>Apply_Social_Case_Record_Type</fullName>
        <description>Change Case Record Type to &quot;Digital Engagement - Social Case&quot;</description>
        <field>RecordTypeId</field>
        <lookupValue>Digital_Engagement_Social_Case</lookupValue>
        <lookupValueType>RecordType</lookupValueType>
        <name>Apply Social Case Record Type</name>
    ...
    <rules>
        ...
        <actions>
            <name>Apply_Social_Case_Record_Type</name>
        ...
        <description>For Social Cases, Assign to &apos;Social Queue&apos; and apply Social Case Record Type</description>
    ...
    <rules>
        ...
        <failedMigrationToolVersion>236.9.6</failedMigrationToolVersion>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
...
ISPICKVAL(Status, &quot;Closed&quot;) 
    ...
    <tasks>
        ...
        <assignedTo>majimenez@copado.com2023/07/18_17-7-41.demo3</assignedTo>
