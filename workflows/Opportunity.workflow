...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>majimenez@copado.com2023/07/18_17-7-41.demo3</recipient>
            <type>user</type>
        </recipients>
    ...
    <fieldUpdates>
        <fullName>Check_Pricing_Approved</fullName>
        <field>Pricing_Approved__c</field>
        <literalValue>1</literalValue>
        <name>Check &quot;Pricing Approved&quot;</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
...
Push_Counter__c + 1 
    ...
    <fieldUpdates>
        <fullName>Set_Stage_to_Proposal_Quote</fullName>
        <field>StageName</field>
        <literalValue>Proposal/Quote</literalValue>
        <name>Set Stage to Proposal/Quote</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
