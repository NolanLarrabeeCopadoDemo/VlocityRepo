...
import { OMNIDEF } from './expediteOrderOSEnglish_def.js';
import tmpl from './expediteOrderOSEnglish.html';
import tmpl_nds from './expediteOrderOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class expediteOrderOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
