import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "omnistudio/flexCardUtility";
          ...
          export default class cfPayoutSummary_2_Admin extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfPayoutSummary_2_Admin';
              @track record;
