...
import { OMNIDEF } from './docGenOmniStudioComponentMultiLanguage_def.js';
import tmpl from './docGenOmniStudioComponentMultiLanguage.html';
import tmpl_nds from './docGenOmniStudioComponentMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenOmniStudioComponentMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
