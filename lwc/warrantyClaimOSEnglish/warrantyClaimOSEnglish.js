...
import { OMNIDEF } from './warrantyClaimOSEnglish_def.js';
import tmpl from './warrantyClaimOSEnglish.html';
import tmpl_nds from './warrantyClaimOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class warrantyClaimOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
