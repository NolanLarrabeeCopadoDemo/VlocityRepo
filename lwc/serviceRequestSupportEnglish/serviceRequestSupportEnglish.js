...
import { OMNIDEF } from './serviceRequestSupportEnglish_def.js';
import tmpl from './serviceRequestSupportEnglish.html';
import tmpl_nds from './serviceRequestSupportEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceRequestSupportEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
