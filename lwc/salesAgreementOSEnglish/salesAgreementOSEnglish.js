...
import { OMNIDEF } from './salesAgreementOSEnglish_def.js';
import tmpl from './salesAgreementOSEnglish.html';
import tmpl_nds from './salesAgreementOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class salesAgreementOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
