...
import { OMNIDEF } from './docGenOmniStudioComponentEnglish_def.js';
import tmpl from './docGenOmniStudioComponentEnglish.html';
import tmpl_nds from './docGenOmniStudioComponentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenOmniStudioComponentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
