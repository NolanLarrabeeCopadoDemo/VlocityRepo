...
import { OMNIDEF } from './teamCreateOrderEnglish_def.js';
import tmpl from './teamCreateOrderEnglish.html';
import tmpl_nds from './teamCreateOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teamCreateOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
