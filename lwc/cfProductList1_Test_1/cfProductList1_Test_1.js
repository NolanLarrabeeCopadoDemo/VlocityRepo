import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfProductList1_Test_1 extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfProductList1_Test_1';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_selectedproductslist`,this._allMergeFields,this._regexPattern,"noparse");
            ...
            this.customEventName1 = interpolateWithRegex(`passqty`,this._allMergeFields,this._regexPattern,"noparse");
