...
import { OMNIDEF } from './productRegistrationDCEnglish_def.js';
import tmpl from './productRegistrationDCEnglish.html';
import tmpl_nds from './productRegistrationDCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class productRegistrationDCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
