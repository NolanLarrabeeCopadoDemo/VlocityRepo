...
import { OMNIDEF } from './serviceRequestServiceAllEnglish_def.js';
import tmpl from './serviceRequestServiceAllEnglish.html';
import tmpl_nds from './serviceRequestServiceAllEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceRequestServiceAllEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
