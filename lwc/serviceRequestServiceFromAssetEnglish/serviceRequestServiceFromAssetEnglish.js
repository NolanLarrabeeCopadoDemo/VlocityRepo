...
import { OMNIDEF } from './serviceRequestServiceFromAssetEnglish_def.js';
import tmpl from './serviceRequestServiceFromAssetEnglish.html';
import tmpl_nds from './serviceRequestServiceFromAssetEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceRequestServiceFromAssetEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
