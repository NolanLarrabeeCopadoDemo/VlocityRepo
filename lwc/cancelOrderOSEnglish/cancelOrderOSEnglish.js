...
import { OMNIDEF } from './cancelOrderOSEnglish_def.js';
import tmpl from './cancelOrderOSEnglish.html';
import tmpl_nds from './cancelOrderOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cancelOrderOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
