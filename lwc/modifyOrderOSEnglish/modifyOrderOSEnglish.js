...
import { OMNIDEF } from './modifyOrderOSEnglish_def.js';
import tmpl from './modifyOrderOSEnglish.html';
import tmpl_nds from './modifyOrderOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class modifyOrderOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
