...
import { OMNIDEF } from './rebateSetupOSEnglish_def.js';
import tmpl from './rebateSetupOSEnglish.html';
import tmpl_nds from './rebateSetupOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rebateSetupOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
