...
import { OMNIDEF } from './returnOrderOSEnglish_def.js';
import tmpl from './returnOrderOSEnglish.html';
import tmpl_nds from './returnOrderOSEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class returnOrderOSEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
